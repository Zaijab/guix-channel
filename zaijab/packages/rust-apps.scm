...
(define-module (zaijab packages rust-apps)
  #:use-module (zaijab packages crates-io)
...
(define-public ripgrep-all
  (let ((release "0.9.6")
        (revision "1")
        (commit "07c9f539fb756a73aac52ff2faac566d7a0c3766"))
    (package
      (name "ripgrep-all")
      ...
      (source
       (origin
         (method git-fetch)
         (uri (git-reference
               (url "https://github.com/lafrenierejm/ripgrep-all")
               (commit "gron")))
         (file-name (git-file-name name version))
         (sha256
          (base32 "06av3k0hbkzcj3s545mdrfpjxx3f9m8iv8vclh7ybjwjlkh1md56"))))
      (build-system cargo-build-system)
      (arguments
       `(#:cargo-inputs
