...
(define elfeed-configuration
  (home-emacs-configuration
   (packages (list
	      ...
	      emacs-elfeed-tube
	      curl))
   (init '(; channel_id -> playlist_id and change UC* -> UULF to remove shorts 
	   (setq elfeed-feeds '(("https://almostsuremath.com/feed/" math almost-sure reading)
				("https://karthinks.com/index.xml" crafter karthinks reading)
				("https://jamesg.blog/hf-papers.xml" machine-learning reading)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=UULF2D2CMWXMOVWx7giW1n3LIg" health huberman)
...
(define (use-emacs-next package)
  (if #t
      ((options->transformation '((with-git-url . "emacs-org=https://code.tecosaur.net/tec/org-mode.git")
				  (with-commit . "emacs-org=14dc4837b717a52bca0fb291a36d3441e97b2c73")
