...
(define elfeed-configuration
  (home-emacs-configuration
   ...
   (init '((setq elfeed-feeds '(("https://almostsuremath.com/feed/" math almost-sure reading)
				...
				("https://www.youtube.com/feeds/videos.xml?channel_id=UCzB7YGrrxDC_POenf86H3_Q" programming ryanpeterman)
				...
				("https://www.youtube.com/feeds/videos.xml?channel_id=UC6hv_oxteMQcErpybAb73Lg" buddhism baus)
				("https://www.youtube.com/feeds/videos.xml?channel_id=UC2Jb9--_98wQPlbTWP7GBgw" fun noita dunkorslam thediaryofdunk)
				("https://www.youtube.com/feeds/videos.xml?channel_id=UCwBEhH4-1iOnI2GQBIT0Ohg" fun noita dunkorslam)
  ...
  (home-emacs-configuration
   ...
   (init '(
	   (use-package jupyter
			...
			(setf (alist-get "python" org-src-lang-modes nil nil (function equal)) 'python-ts)
	   ...
	   (use-package envrc
			...
			(add-hook 'org-mode-hook (function envrc-global-mode-enable-in-buffer) -90))
    ...
    (set! blight-configuration
	  (home-emacs-configuration
	   ...
	   (init '((shell-command "sudo chmod 777 /sys/class/backlight/amdgpu_bl0/brightness")
		   (require 'blight)
		   (setq my/blight (blight-sysfs :min 0))
