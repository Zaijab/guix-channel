...
(define cape-configuration
  (home-emacs-configuration
   ...
   (init '((require 'tempel)
	   ...
	   (setq completion-at-point-functions (cons (function tempel-complete) completion-at-point-functions))
...
(define elfeed-configuration
  (home-emacs-configuration
   ...
   (init '((setq elfeed-feeds '(("https://www.youtube.com/feeds/videos.xml?channel_id=UC2D2CMWXMOVWx7giW1n3LIg" huberman-lab)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PL5B3KLQNAC5j46Ro64xF7hLV6Uf-gHUHL" continuum-mechanics)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLEC88901EBADDD980" mit-odes)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PL221E2BBF13BECF6C" mit-linear-algebra)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLLq_gUfXAnkkvL_UoCGivS0wOYhwCtczI" mit-pde)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLLq_gUfXAnkmC-VWIJ_HW8cdOZLEtHfXJ" dynamical-systems)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PL4C4C8A7D06566F38" mit-multivariable-calc)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLzUeAPxtWcqzr80lS25FrzMn7a36BuXhj" algebra-gross)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLpRLWqLFLVTCL15U6N3o35g4uhMSBVA2b" topology-pierre-albin)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLTBqohhFNBE_09L0i-lf3fYXF5woAbrzJ" topology-tokieda)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLLq_gUfXAnkl8bjQh-hGQ9u24xZP9x0dx" topology-bruno)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLp0hSY2uBeP_HDgkCSrG5pccHYfudTJYI" topology-pavel)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLBEeOnR8lrBHNZWwk8-pHOQLQnP3u8bO8" topology-clark)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PL6763F57A61FE6FE8" topology-wildberger)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=PLjJC3hyewH5BqfdAhehFXDQ5zZjZMCGez" xenoblade-3-ost)
				("https://www.youtube.com/feeds/videos.xml?playlist_id=OLAK5uy_l61-xQRkAwn7ZmwwBDeGuCxnofeHFrNzw" octopath-ost)))
	   (require 'elfeed-tube)
	   (elfeed-tube-setup)
...
(define exwm-configuration
  (home-emacs-configuration
   ...
   (init '((require 'exwm)
	   ...
	   (global-set-key (kbd "s-J")    'windsize-up)
	   (global-set-key (kbd "s-K")  'windsize-down)
